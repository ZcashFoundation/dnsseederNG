...
mod tests {
    ...
    fn test_ipv4_is_global() {
        ...
        assert!(unspecified.is_unspecified(), "Unspecified should be detected");
    ...
    fn test_private_ipv4_ranges() {
        ...
        let is_global_10 = !private_10.is_loopback() && !private_10.is_unspecified() && !private_10.is_multicast();
        let is_global_172 = !private_172.is_loopback() && !private_172.is_unspecified() && !private_172.is_multicast();
        let is_global_192 = !private_192.is_loopback() && !private_192.is_unspecified() && !private_192.is_multicast();
    ...
    fn test_dns_response_constants() {
        ...
        assert_eq!(MAX_DNS_RESPONSE_PEERS, 25, "Should return max 25 peers per query");
        assert_eq!(PEER_SELECTION_POOL_SIZE, 50, "Should collect 50 peers for randomization");
        assert!(PEER_SELECTION_POOL_SIZE >= MAX_DNS_RESPONSE_PEERS * 2, 
